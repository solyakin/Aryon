     ...
     <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="max-w-2xl w-full space-y-8 text-center">
        <div 
          ...
          aria-hidden="true"
        >
          <div className="absolute -inset-0.5 bg-gradient-to-r from-teal-500 to-blue-500 rounded-lg blur opacity-50 animate-pulse" />
          <div className="relative bg-white dark:bg-gray-800 px-4 py-2 rounded-lg">
            <AlertCircle className="h-12 w-12 text-teal-500 mx-auto" />
          </div>
        </div>
