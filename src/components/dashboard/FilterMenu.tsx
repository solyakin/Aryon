  ...
  return (
    <Popover>
        ...
        <div 
            ...
            tabIndex={0}
            className="border border-accent p-2.5 rounded-sm flex items-center justify-center sm:justify-start gap-2 hover:bg-card transition-colors bg-card cursor-pointer w-full sm:w-auto"
        >
            <Filter className="size-3 text-card-foreground" aria-hidden="true" />
            <span className="text-sm text-card-foreground">Filter</span>
        ...
        <div data-testid="filter-popover" className="p-2 border-b border-accent">
            <div className="flex items-center gap-2 p-1.5">
                ...
                <input
                    ...
                    className="border-none outline-none text-sm focus:ring-0 bg-transparent w-full text-card-foreground"
        ...
        <div className="border-t border-accent">
            ...
            className="w-full text-center text-sm font-medium px-2 py-2 text-muted-foreground cursor-pointer transition-colors"
